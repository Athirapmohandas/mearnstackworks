...
//country name , population of 1st=Equador
console.log(data[0].name["common"]);
console.log(data[0].population);
console.log(data[0].currencies["USD"].symbol);

//country name , population 
//data.forEach(country=>console.log("country name:",country.name.common,",Population:",country.population))
// coutry name along with currency symbol
//data.forEach(country=>console.log("name:",country.name.common,"Symbol",country.currencies))
...
var symbols=countries.map(country=>country.currencies[0].symbol)
console.log(symbols);